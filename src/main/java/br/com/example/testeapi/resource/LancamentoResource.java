...
import br.com.example.testeapi.exceptionhandler.TesteExceptionHandler;
...
import br.com.example.testeapi.service.LancamentoService;
...
public class LancamentoResource {
    ...
    public ResponseEntity<Object> handlePessoaInexistenteOuInativaException (PessoaInexistenteOuInativaException ex){
        ...
        List<TesteExceptionHandler.Erro> erros = Arrays.asList(new TesteExceptionHandler.Erro(mensagemUsuario, mensagemDesenvolvedor));
